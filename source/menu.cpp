...
GuiSound *btnSoundClick3 = NULL;
GuiSound *btnSoundAccept = NULL;
GuiSound *btnSoundBack = NULL;
...
int MainMenu(int menu)
{
	...
	btnSoundClick3 = new GuiSound(NULL, 0, Settings.sfxvolume);
	btnSoundClick3->LoadSoundEffect(Resources::GetFile("button_click3.wav"), Resources::GetFileSize("button_click3.wav"));
	btnSoundAccept = new GuiSound(NULL, 0, Settings.sfxvolume);
	btnSoundAccept->LoadSoundEffect(Resources::GetFile("button_accept.wav"), Resources::GetFileSize("button_accept.wav"));
	btnSoundBack = new GuiSound(NULL, 0, Settings.sfxvolume);
	btnSoundBack->LoadSoundEffect(Resources::GetFile("button_back.wav"), Resources::GetFileSize("button_back.wav"));
